...
<<<<<<< HEAD
const EVERY_DAY_AT_MIDNIGHT_AND_3_MINUTES = '3 0 * * *';
const EVERY_WEEK_AT_MONDAY_MIDNIGHT_AND_8_MINUTES = '8 0 * * 1';
...
<<<<<<< HEAD
    SYNC_SUBSCRIPTION_IMPORT_SOURCES: CronExpression.EVERY_5_MINUTES,

    RECORD_USER_USAGE: EVERY_15_SECONDS,

    RESET_USER_TRAFFIC: {
        DAILY: EVERY_DAY_AT_MIDNIGHT_AND_3_MINUTES,
        WEEKLY: EVERY_WEEK_AT_MONDAY_MIDNIGHT_AND_8_MINUTES,
