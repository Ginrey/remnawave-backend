...
<<<<<<< HEAD
    ...
    SUBSCRIPTION_IMPORT_SOURCES: {
        GET: `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.GET}`,
        CREATE: `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.CREATE}`,
        UPDATE: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.UPDATE(uuid)}`,
        GET_BY_UUID: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.GET_BY_UUID(uuid)}`,
        DELETE: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.DELETE(uuid)}`,
        ACTIONS: {
            FETCH_NOW: (uuid: string) =>
                `${ROOT}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_CONTROLLER}/${CONTROLLERS.SUBSCRIPTION_IMPORT_SOURCES_ROUTES.ACTIONS.FETCH_NOW(uuid)}`,
=======
